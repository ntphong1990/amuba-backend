...
class CardFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'destination' => ['type' => 'string', 'length' => 1000, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'totalPrice' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'feeShiping' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'created_at' => 1465618927,
            'updated_at' => 1465618927,
            'status' => 1,
            'recordStatus' => 1
        ],
    ];
